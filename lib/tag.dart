...
/// Person tags
@freezed
abstract class PTag with _$PTag implements ID {
...
/// Note tags
@freezed
abstract class NTag with _$NTag implements ID {
...
/// have any replica.
@freezed
abstract class NoteReplica with _$NoteReplica implements ID, OnDate {
  factory NoteReplica({
    String id, // noteId
    String personId,
    String content,
